...
public class TestStatisticsGeneratorApplication {
		...
		/**
		 * Transaction within last sixty seconds
		 */
		@Test
		...
		/**
		 * Transaction before last sixty seconds
		 */
		@Test
	    ...
	    public void testFunctionality() throws InterruptedException {
	        ...
	        Assert.assertEquals(2,response5.getBody().getCount().intValue());
